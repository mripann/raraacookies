    ...
    <div class="container">
        ...
        <div class="row align-items-center mb-5">
            ...
            <div class="col-md-6">
                ...
                <p style="color: black;">FishApp adalah platform inovatif yang menghubungkan penjual dengan pembeli yang mencari hasil dan rasa kue kering berkualitas. Kami berkomitmen untuk memberdayakan produk lokal dan memberikan akses mudah kepada konsumen untuk mendapatkan produk yang lezat dan berkualitas.</p>
...
<div class="container py-5">
    <h2 class="text-center mb-5" style="color: #097ABA;">Cara Bergabung dengan FishApp</h2>
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-5 col-md-6">
            <div class="bg-light p-4 rounded shadow-sm text-center h-100">
                ...
                <p>Bergabung dengan FishApp sebagai pembeli dan nikmati hasil laut segar.</p>
            ...
            <div class="col-md-6">
                <div class="d-flex align-items-start">
                    ...
                    <div>
                        ...
                        <p>FishApp memastikan produk laut yang Anda beli adalah hasil tangkapan segar dan berkualitas.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
